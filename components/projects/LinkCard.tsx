...
const LinkCard = (props) => {
    ...
    return (
        <div className={`card bg-base-300 shadow-md py-2 ${sizeMb > 50 ? 'cursor-not-allowed' : 'hover:ring-2'} `}>
            <div className='flex justify-between items-center'>
                ...
                <div className='flex flex-col items-center mr-2'>
                    <button onClick={() => handleCreateProject(name, link)} disabled={sizeMb > 50} className={`btn btn-xs mt-2 mr-2`}>import</button>
