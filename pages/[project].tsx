    ...
    return (
        <div className='mb-32 relative container mx-auto'>
            ...
            <div className={`card bg-base-400 shadow-xl relative m-16 ${isLoading && "card-project"}`}>
                ...
                <div className="dropdown dropdown-bottom dropdown-end absolute top-2 right-2 ">
                    <label tabIndex={0} className="btn btn-square btn-ghost"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul tabIndex={0} className="dropdown-content menu p-2 shadow bg-base-200 rounded-box w-52">
                        <li onClick={() => router.push(`/create/secrets?projectId=${projectId}&statusId=${status.id}&name=${title}&id=${id}&metricId=${projectMetrics.id}`)
                        }><a>Edit Secrets - .env</a></li>
                        <li onClick={handleDelete}><a className='btn-outline btn-error'>Delete</a></li>
                    </ul>
                </div>
